...
{
    std::vector<std::string> texture = {"resources/Images/box_dropper_tube.bmp", "resources/Images/plasticwall001b.bmp", "resources/Images/underground_wall_metal001a.bmp", "resources/Images/metalwall1_lrg.bmp"};
