...
SimpleObject::SimpleObject(Vector3D pos,  Vector3D scale, Vector3D rotation) :
 Object(pos, scale, rotation){
     std::vector<std::string> texture = {"resources/Images/steve_front.bmp", "resources/Images/steve_back.bmp", "resources/Images/steve_right.bmp", "resources/Images/steve_left.bmp", "resources/Images/steve_top.bmp", "resources/Images/steve_bottom.bmp", };
