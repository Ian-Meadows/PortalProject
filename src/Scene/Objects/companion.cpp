...
{
    std::vector<std::string> texture = {"resources/Images/metalwall1_med.bmp", "resources/Images/underground_wall_metal004d.bmp", "resources/Images/woodpanel_002.bmp", "resources/Images/metal_detail_01.bmp"};
